...
import (
    ...
    "github.com/rs/cors"
    "horizon-web/backend/internal/handler"
    // "horizon-web/backend/internal/middleware"
    "horizon-web/backend/internal/repository"
    "horizon-web/backend/internal/service"
    "horizon-web/backend/pkg/db"
)
